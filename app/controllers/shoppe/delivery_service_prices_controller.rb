  ...
  class DeliveryServicePricesController < Shoppe::ApplicationController
    ...
    def create
      ...
      if @delivery_service_price.save
        redirect_to [@delivery_service, :delivery_service_prices], :notice => "Precio creado satisfactoriamente"
      else
        render :action => "new"
      end
    end
    ...
    def update
      if @delivery_service_price.update(safe_params)
        redirect_to [@delivery_service, :delivery_service_prices], :notice => "Precio modificado satisfactoriamente"
      else
        render :action => "edit"
      end
    end
    ...
    def destroy
      ...
      redirect_to [@delivery_service, :delivery_service_prices], :notice => "Precio eliminado satisfactoriamente"
    end
