  ...
  class ProductCategoriesController < Shoppe::ApplicationController
    ...
    def create
      ...
      if @product_category.save
        redirect_to :product_categories, :flash => {:notice => "Categoria creada satisfactoriamente"}
      else
        render :action => "new"
      end
    end
    ...
    def update
      if @product_category.update(safe_params)
        redirect_to [:edit, @product_category], :flash => {:notice => "Categoria modificada satisfactoriamente"}
      else
        render :action => "edit"
      end
    end
    ...
    def destroy
      ...
      redirect_to :product_categories, :flash => {:notice => "Categoria eliminada satisfactoriamente"}
    end
